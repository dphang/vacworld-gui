...
public class VacPercept extends Percept {
    ...
    /**
     * Construct a vacuum world percept. If the agent is in a squa e that has
     * dirt, then create a percept that sees dirt. If the agent is directly in
     * front of and facing an obstacle, then the agent can see the obstacle. If
     * the agent moved into an obstacle on the previous turn the agent will feel
     * a bump.
     */
    ...
    /**
     * Returns true if the percept reflects that the agent bumped into an
